...
async def confirm(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == 0:
        ...
        keyboard = [[InlineKeyboardButton("Task 1", url="https://t.me/pocketfi_bot/Contest?startapp=Usmon5504_9593"),
                     InlineKeyboardButton("Task 2", url="https://t.me/+cMUZesdEu25hODZi")],
                    [InlineKeyboardButton("Confirm✅", callback_data="confirm")]]
        user_states[user_id] = 1  # Holatni 1 ga oshiramiz
        ...
        keyboard = [[InlineKeyboardButton("Task 1", url="https://t.me/pocketfi_bot/Contest?startapp=Usmon5504_9593"),
                     InlineKeyboardButton("Task 2", url="https://t.me/+cMUZesdEu25hODZi")],
                    [InlineKeyboardButton("Confirm✅", callback_data="confirm")]]
        user_states[user_id] = 2  # Holatni 2 ga oshiramiz

    elif state == 2:
        message = "You have not completed Task 2❌"
        keyboard = [[InlineKeyboardButton("Task 1", url="https://t.me/pocketfi_bot/Contest?startapp=Usmon5504_9593")],
                    [InlineKeyboardButton("Confirm✅", callback_data="confirm")]]
        user_states[user_id] = 3  # Holatni 3 ga oshiramiz
        ...
        user_states[user_id] = 4  # Holatni 4 ga o‘rnatamiz (bot oddiy rejimga o‘tadi)
...
def main():
    ...
    TOKEN = "7815584845:AAF1NA4Ain45TPJYJPbMQEX8G3w4ABwxAUs"
